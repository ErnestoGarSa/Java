...
class Hamburger {
    ...
    public void addHamburgerAddition2(String addition2Name, double additionPrice2) {
        System.out.println("Added " + addition2Name + " for an extra " + additionPrice2);
        price += additionPrice2;
    }

    public void addHamburgerAddition3(String addition3Name, double additionPrice3) {
        System.out.println("Added " + addition3Name + " for an extra " + additionPrice3);
        price += additionPrice3;
    }

    public void addHamburgerAddition4(String addition4Name, double additionPrice4) {
        System.out.println("Added " + addition4Name + " for an extra " + additionPrice4);
        price += additionPrice4;
    }
...
class DeluxeBurger extends Hamburger {
    private double price;
    public DeluxeBurger(String name, String breadRollType, double price, String meat) {
        super(name, breadRollType, price, meat);
    }

    public DeluxeBurger() {
        super("Deluxe ", "White roll", 14.54, "Sausage & Bacon");
...
class HealthyBurger extends Hamburger {
    ...
    public HealthyBurger(String meat, double price) {
        super("Healthy hamburger", "rye roll", price, meat);
        System.out.println("Healthy hamburger on a " + meat + " rye roll with Bacon, price is " + price);
    }
